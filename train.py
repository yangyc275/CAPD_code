...
from model.CAPD import Net, SupervisedLoss, UnSupervisedLoss
...
def get_parser():
    ...
    # parser.add_argument("--num_iter_layers",
    #                     type=int,
    #                     default=4,
    #                     help="num_iter_layers")
    # parser.add_argument("--use_CrossAtt",
    #                     type=bool,
    #                     default=False,
    #                     help="use CrossAttention")
...
if __name__ == "__main__":
    ...
    model = Net(cfg.num_category, cfg.num_prior, cfg.use_CrossAtt)
